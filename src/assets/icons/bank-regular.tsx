...
export function BankRegular({ color, height, width }: IconProps) {
  return (
    <svg
      width={width || "32"}
      height={height || "32"}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15.4759 3.14834C15.7973 2.95055 16.2027 2.95055 16.5241 3.14834L29.5241 11.1483C29.9051 11.3828 30.084 11.8419 29.9622 12.2723C29.8403 12.7028 29.4474 13 29 13H2.99999C2.5526 13 2.15964 12.7028 2.03779 12.2723C1.91595 11.8419 2.09487 11.3828 2.4759 11.1483L15.4759 3.14834ZM6.53304 11H25.467L16 5.17418L6.53304 11Z"
        fill={color}
      />
      <path
        fillRule="evenodd"
      ...
      <path
        fillRule="evenodd"
        clip-rule="evenodd"
        d="M1 25.9999C1 25.4477 1.44772 24.9999 2 24.9999H30C30.5523 24.9999 31 25.4477 31 25.9999C31 26.5522 30.5523 26.9999 30 26.9999H2C1.44772 26.9999 1 26.5522 1 25.9999Z"
        fill={color}
      />
    </svg>
  );
